...
subjective_path = str(os.getcwd()) + "/final_year_project/automated-test-platform-master/automated-test-platform-master/atp/static/data/db/user_data_log_subjective.csv"
objective_path = str(os.getcwd()) +  "/final_year_project/automated-test-platform-master/automated-test-platform-master/atp/static/data/db/user_data_log_objective.csv"


def back_up_data(uname, usn, semester, subject_name, score_obt, flag):
    ...
    row = [date, month, year, uname, usn, semester, subject_name, score_obt]
...
def relative_ranking(subjectname, flag):
    ...
    max_score = max(temp_df["score_obt"])
    min_score = min(temp_df["score_obt"])
    mean_score = temp_df["score_obt"].mean()
